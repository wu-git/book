'use strict';(function(){const searchDataURL='/en.search-data.min.475f07cad4208d1ac203a5ee50a5f751027a2ca80ad60380ef3b0cbd2da7f82f.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
