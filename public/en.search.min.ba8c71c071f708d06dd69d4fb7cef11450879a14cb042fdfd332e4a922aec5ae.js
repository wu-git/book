'use strict';(function(){const searchDataURL='/en.search-data.min.3b97b4f109a98d22678231bc6f3a57d68b1f51ce81bfa9d67a7d84d7e99661d0.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
