'use strict';(function(){const searchDataURL='/en.search-data.min.b803620f39d6fcdfb9cc84b7f6222602556a04cd1068dd4e387b54b0b3e0510f.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
