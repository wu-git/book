'use strict';(function(){const searchDataURL='/en.search-data.min.4c0fe2e85f513ab52a51e152216e5d367484b9a246e83368b12ceffdb4d5e115.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
