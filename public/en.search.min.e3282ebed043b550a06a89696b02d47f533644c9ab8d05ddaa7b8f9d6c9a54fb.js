'use strict';(function(){const searchDataURL='/en.search-data.min.146c14980100d7c81b05275b19fe7b8a634562f2eb294f8ef1006325690c4b8d.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
