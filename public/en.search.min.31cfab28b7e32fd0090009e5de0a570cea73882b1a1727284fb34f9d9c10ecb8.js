'use strict';(function(){const searchDataURL='/en.search-data.min.586196668fa346d77cee0e76304eec9d6521f7f053dbf987c133e22b9bf5172a.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
