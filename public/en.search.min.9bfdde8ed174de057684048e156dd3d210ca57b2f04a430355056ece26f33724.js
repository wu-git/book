'use strict';(function(){const searchDataURL='/en.search-data.min.5edfea553e57329b007e1a5e72e528275873c5d375bee0a575b043c42f20bf0d.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
