'use strict';(function(){const searchDataURL='/en.search-data.min.f76a93d02232c1373fbeab54f086108cc082a2bcd35d59304ec0a0651e4f0f90.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
