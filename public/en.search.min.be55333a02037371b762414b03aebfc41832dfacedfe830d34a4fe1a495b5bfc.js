'use strict';(function(){const searchDataURL='/en.search-data.min.902db7e05a911218b0f9467a3165c9b9c1c33eaa4a5c6dbf470d995552982b80.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
