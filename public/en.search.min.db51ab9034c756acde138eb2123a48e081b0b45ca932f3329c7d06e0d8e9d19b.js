'use strict';(function(){const searchDataURL='/en.search-data.min.cfc5d9923a28b47bd85742dc6dfab33c040258b0b5bc97d2960a322275e320d7.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
