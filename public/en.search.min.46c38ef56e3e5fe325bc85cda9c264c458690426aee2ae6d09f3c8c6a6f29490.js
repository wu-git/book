'use strict';(function(){const searchDataURL='/en.search-data.min.2d7d3862003219e4890f7823341aed13083a75cd2ac63ada2104583198b35b8f.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
