'use strict';(function(){const searchDataURL='/en.search-data.min.96a4b5ea3e0f25c2a9e89a460b9e3a329b2d2daa12e24fad15b00736b19fda83.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
