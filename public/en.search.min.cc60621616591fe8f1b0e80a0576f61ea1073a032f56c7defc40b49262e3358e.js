'use strict';(function(){const searchDataURL='/en.search-data.min.75dff8a7c03a689c91376457b276f8422267b9269587b3b3f449310c8e78e8e0.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
