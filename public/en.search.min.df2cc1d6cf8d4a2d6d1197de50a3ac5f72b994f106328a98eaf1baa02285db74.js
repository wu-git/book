'use strict';(function(){const searchDataURL='/en.search-data.min.cbcffcdd5acdb07896176ed6b90635b5939bc990f8071c05cd4b5d79fcbf029f.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
